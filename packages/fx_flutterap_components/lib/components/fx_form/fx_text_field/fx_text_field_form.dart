...
class FxTextFieldForm extends StatefulWidget {
  final String? hint;
  final String? label;
  ...
  const FxTextFieldForm(
      ...
      this.borderStyle,
      this.focusedBorder,
      this.focusedErrorBorder, InputDecoration? decoration})
      : super(key: key)
...
class _EsSpecificTextField extends State<FxTextFieldForm> {
  Color _borderColor = InitialStyle.borderInput;
    ...
    if (isObscure) {
      return InputDecoration(
          ...
          labelStyle: widget.labelStyle ??
              TextStyle(
                fontSize: DefaultDims.subtitleFontSize(context),
