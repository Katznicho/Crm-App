...
class FxBottomTabBarNavigation extends StatefulWidget {
  ...
  const FxBottomTabBarNavigation({
    Key? key,
  ...
  State<StatefulWidget> createState() {
    ...
    return _FxBottomTabBarNavigationState();
  }
}

class _FxBottomTabBarNavigationState extends State<FxBottomTabBarNavigation>
