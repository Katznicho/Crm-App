...
import 'package:fx_flutterap_components/components/fx_group_button/utils/extensions/extensions.dart';
import 'package:fx_flutterap_components/components/fx_group_button/utils/models/alignments.dart';
import 'package:fx_flutterap_components/components/fx_group_button/utils/models/grouping_type.dart';
import 'package:fx_flutterap_components/components/fx_group_button/utils/models/types.dart';
import 'package:flutter/material.dart';

import 'fx_group_button_item.dart';
...
class GroupButtonBody<T> extends StatefulWidget {
  ...
  final List<Widget> buttonsWidget;
  ...
  List<Widget> _generateButtonsList() {
    ...
    for (var i = 0; i < widget.buttons.length; i++) {
      ...
      if (buttonBuilder != null || buttonIndexedBuilder != null) {
        ...
        button = FxGroupButtonItem(
          widget: widget.buttonsWidget[i],
